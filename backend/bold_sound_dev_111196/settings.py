"""
Django settings for bold_sound_dev_111196 project.
...
ROOT_URLCONF = 'bold_sound_dev_111196.urls'
...
WSGI_APPLICATION = 'bold_sound_dev_111196.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bold_sound_dev_111196 API",
    "DESCRIPTION": "API documentation for bold_sound_dev_111196 App",
    "VERSION": "v1",
}
